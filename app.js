...
app.get("/", (req, res) => {
  res.send(
    `<div style='display: flex; justify-content: center;  height: 100vh;'><div><h1>Welcome to the Spies Test Server</h1><p>This is a simple server for the Spies Test. Behave yourself and Happy Chanuka!</p></div></div>`
  );
});
